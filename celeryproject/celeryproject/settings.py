...
SECRET_KEY = 'django-insecure-=ag1yfm(h4fpfa2uycnlxrjwcrhjns9c$uf(ek#**@)w8h$v82'
...
# Enables extended task result attributes (name, args, kwargs, worker, retries, queue, delivery
# info) to be written to backend.
